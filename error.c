...
void unterminated_comment(const struct ainfo *a)
{
...
void unterminated_string(const struct ainfo *a)
{
...
void unterminated_text(const struct ainfo *a)
{
	fprintf(stderr, "%s: e - line %d of \"%s\", unmatched %%{\n",
	        myname, a->a_lineno, input_file_name);
	print_pos(a->a_line, a->a_cptr);
...
void unterminated_union(const struct ainfo *a)
{
	fprintf(stderr,
...
void unterminated_action(const struct ainfo *a)
{
...
{
	fprintf(stderr,
	    "%s: w - line %d of \"%s\", the default action for %s assigns "
	    "an undefined value to $$\n",
	    myname, lineno, input_file_name, s);
}
...
void unterminated_arglist(const struct ainfo *a)
{
	fprintf(stderr,
...
{
	fprintf(stderr,
	    "%s: w - line %d of \"%s\", number of arguments of %s "
...
{
	fprintf(stderr,
	    "%s: w - line %d of \"%s\", type of argument %d "
	    "to %s doesn't agree with previous declaration\n",
	    myname, a_lineno, input_file_name, i, a_name);
}

void unknown_arg_warning(int d_lineno, const char *dlr_opt, const char *d_arg, const char *d_line, const char *d_cptr)
{
...
void untyped_arg_warning(int a_lineno, const char *dlr_opt, const char *a_name)
{
...
void destructor_redeclared_warning(const struct ainfo *a)
{
